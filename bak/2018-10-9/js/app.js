...
//var website = 'http://192.168.168.178:9090';
...
function sw_post(url, data, callback) {
//	data.apikey = apikey;
    DEBUG && print_request_log("POST", apiurl + url, data, callback);
...
function sw_get(url, data, callback) {
//	data.apikey = apikey;
    DEBUG && print_request_log("POST", apiurl + url, data, callback);
